...
| `licensing` | 108 | license, trademark, DCO | [`docs/LICENSING_OPTIONS.md`](docs/LICENSING_OPTIONS.md), [`docs/CONTRIBUTION_RADAR_DECISION.md`](docs/CONTRIBUTION_RADAR_DECISION.md), [`LICENSE`](LICENSE) |
...
| `docs/LICENSING_OPTIONS.md` | License/trademark/DCO options brief (does not change `LICENSE`). | license, decision | Owner license decision before opening contributions. | Human decision brief |
